...
namespace Talleres.Web.Tests
{
    public abstract class TalleresWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TalleresWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TalleresWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TalleresDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TalleresDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TalleresDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TalleresDbContext, Task<T>> func)
        {
            T result;
